...
export const { delete: deleteSurplusPackage } = makeCRUDThunks(
  "content-operation/surplus-package",
  Surplus_PackageAPI,
);

export const activateSurplusPackage = createAsyncThunk(
  "content-operation/surplus-package/activate",
  async (id, { dispatch }) => {
...
export const getSurplusPackages = createAsyncThunk(
  "orders/order/return-completed-orders",
  async (id) => {
    try {
