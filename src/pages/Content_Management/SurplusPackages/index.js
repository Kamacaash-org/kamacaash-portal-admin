...
const SurplusPackages = () => {
    ...
    const staticBusinessId = "68e3763dd6e0c17018d0386c";
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            try {
                ...
                if (isEdit) {
                    ...
                    await dispatch(onUpdateSurplusPackage(formData));
                } else {
                    await dispatch(onAddNewSurplusPackage(formData));
                }
...
//         <div className="page-content">
//             <Container fluid>
//                 <BreadCrumb title="Surplus Packages" pageTitle="Surplus" />
