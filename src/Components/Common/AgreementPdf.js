            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.partiesSection}>
                    <View style={styles.partyBlock}>
                        ...
                        <Text style={styles.partyName}>Kamacaash Inc.</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.clause}>
                        ...
                        <Text style={styles.text}>means the Kamacaash digital marketplace, mobile application, and associated systems operated by Kamacaash Inc.</Text>
                    </View>
                    <View style={styles.clause}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text}>
                        ...
                        Kamacaash shall provide the Business with:
                    </Text>
                ...
                <View style={styles.signatureSection}>
                    <View style={styles.signatureBlock}>
                        ...
                        <Text style={styles.signatureName}>Kamacaash Inc.</Text>
                ...
                <View style={styles.footer}>
                    <View style={styles.footerLeft}>
                        <Text style={styles.footerBold}>Kamacaash Inc.</Text>
                        <Text style={styles.footerText}>Surplus Food Saver Platform</Text>
                        <Text style={styles.footerText}>www.kamacaash.com | legal@kamacaash.com</Text>
                    </View>
